...
public class AdminDAO {
	...
	public static Admin loadAdminByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Admin) session.load(vae.Admin.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Admin getAdminByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Admin) session.get(vae.Admin.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Admin loadAdminByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Admin) session.load(vae.Admin.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Admin getAdminByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Admin) session.get(vae.Admin.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Admin createAdmin() {
		return new vae.Admin();
	}
	
	public static boolean save(vae.Admin admin) throws PersistentException {
		try {
	...
	public static boolean delete(vae.Admin admin) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(vae.Admin admin)throws PersistentException {
		try {
			vae.PrioritizedAnnouncement[] lProducts = admin.product.toArray();
			for(int i = 0; i < lProducts.length; i++) {
				lProducts[i].seller.remove(admin);
			}
			vae.TripItem[] lTripItems = admin.tripItem.toArray();
	...
	public static boolean deleteAndDissociate(vae.Admin admin, org.orm.PersistentSession session)throws PersistentException {
		try {
			vae.PrioritizedAnnouncement[] lProducts = admin.product.toArray();
			for(int i = 0; i < lProducts.length; i++) {
				lProducts[i].seller.remove(admin);
	...
	public static boolean refresh(vae.Admin admin) throws PersistentException {
		try {
	...
	public static boolean evict(vae.Admin admin) throws PersistentException {
		try {
