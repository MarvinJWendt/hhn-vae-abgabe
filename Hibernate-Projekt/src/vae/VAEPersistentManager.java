...
public class VAEPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "VAE";
	...
	private VAEPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(vae.User.class);
		aMetadataSources.addAnnotatedClass(vae.Traveler.class);
		aMetadataSources.addAnnotatedClass(vae.Admin.class);
		aMetadataSources.addAnnotatedClass(vae.Trip.class);
		aMetadataSources.addAnnotatedClass(vae.Review.class);
		aMetadataSources.addAnnotatedClass(vae.Category.class);
		aMetadataSources.addAnnotatedClass(vae.PrioritizedAnnouncement.class);
		aMetadataSources.addAnnotatedClass(vae.MedicalHelp.class);
		aMetadataSources.addAnnotatedClass(vae.Insurance.class);
		aMetadataSources.addAnnotatedClass(vae.TripItem.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new VAEPersistentManager();
		}
