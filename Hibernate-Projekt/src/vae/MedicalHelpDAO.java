...
public class MedicalHelpDAO {
	...
	public static MedicalHelp loadMedicalHelpByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (MedicalHelp) session.load(vae.MedicalHelp.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MedicalHelp getMedicalHelpByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (MedicalHelp) session.get(vae.MedicalHelp.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MedicalHelp loadMedicalHelpByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MedicalHelp) session.load(vae.MedicalHelp.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MedicalHelp getMedicalHelpByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (MedicalHelp) session.get(vae.MedicalHelp.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static MedicalHelp createMedicalHelp() {
		return new vae.MedicalHelp();
	}
	
	public static boolean save(vae.MedicalHelp medicalHelp) throws PersistentException {
		try {
	...
	public static boolean delete(vae.MedicalHelp medicalHelp) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(vae.MedicalHelp medicalHelp)throws PersistentException {
		try {
			vae.Traveler[] lPatients = medicalHelp.patient.toArray();
	...
	public static boolean deleteAndDissociate(vae.MedicalHelp medicalHelp, org.orm.PersistentSession session)throws PersistentException {
		try {
			vae.Traveler[] lPatients = medicalHelp.patient.toArray();
			for(int i = 0; i < lPatients.length; i++) {
				lPatients[i].medical_provider.remove(medicalHelp);
	...
	public static boolean refresh(vae.MedicalHelp medicalHelp) throws PersistentException {
		try {
	...
	public static boolean evict(vae.MedicalHelp medicalHelp) throws PersistentException {
		try {
