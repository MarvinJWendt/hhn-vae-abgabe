...
public class Trip implements Serializable {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_TRIP_TRAVELER) {
			this.traveler = (vae.Traveler) owner;
		}
	}
	...
	@ManyToOne(targetEntity=vae.Traveler.class, fetch=FetchType.LAZY)	
	...
	@ManyToMany(mappedBy="ORM_tripPlanList", targetEntity=vae.TripItem.class)	
	...
	public void setTraveler(vae.Traveler value) {
		if (traveler != null) {
	...
	public vae.Traveler getTraveler() {
		return traveler;
	}
	 ...
	 */
	public void setORM_Traveler(vae.Traveler value) {
		this.traveler = value;
	}
	
	private vae.Traveler getORM_Traveler() {
		return traveler;
	}
	...
	@Transient	
	public final vae.TripItemSetCollection tripItem = new vae.TripItemSetCollection(this, _ormAdapter, ORMConstants.KEY_TRIP_TRIPITEM, ORMConstants.KEY_TRIPITEM_TRIPPLANLIST, ORMConstants.KEY_MUL_MANY_TO_MANY);
	
	public void add(Item tripItem) {
