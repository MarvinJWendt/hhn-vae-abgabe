...
public class ReviewDAO {
	...
	public static Review loadReviewByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Review) session.load(vae.Review.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Review getReviewByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Review) session.get(vae.Review.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Review loadReviewByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Review) session.load(vae.Review.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Review getReviewByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Review) session.get(vae.Review.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Review createReview() {
		return new vae.Review();
	}
	
	public static boolean save(vae.Review review) throws PersistentException {
		try {
	...
	public static boolean delete(vae.Review review) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(vae.Review review)throws PersistentException {
		try {
			if (review.getTripItem() != null) {
				review.getTripItem().trip_review.remove(review);
			}
			
			vae.Traveler[] lEvaluators = review.evaluator.toArray();
	...
	public static boolean deleteAndDissociate(vae.Review review, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (review.getTripItem() != null) {
				review.getTripItem().trip_review.remove(review);
			}
	...
	public static boolean refresh(vae.Review review) throws PersistentException {
		try {
	...
	public static boolean evict(vae.Review review) throws PersistentException {
		try {
