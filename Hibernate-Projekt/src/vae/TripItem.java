...
public class TripItem implements Serializable {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_TRIPITEM_ANNOUNCEMENT) {
			this.announcement = (vae.PrioritizedAnnouncement) owner;
		}
		
		else if (key == ORMConstants.KEY_TRIPITEM_CATEGORY) {
			this.category = (vae.Category) owner;
		}
	}
	...
	@OneToOne(targetEntity=vae.PrioritizedAnnouncement.class, fetch=FetchType.LAZY)	
	...
	private vae.PrioritizedAnnouncement announcement;
	
	@ManyToOne(targetEntity=vae.Category.class, fetch=FetchType.LAZY)	
	...
	@ManyToMany(targetEntity=vae.Trip.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	...
	@OneToMany(mappedBy="tripItem", targetEntity=vae.Review.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	...
	@Transient	
	public final vae.TripSetCollection tripPlanList = new vae.TripSetCollection(this, _ormAdapter, ORMConstants.KEY_TRIPITEM_TRIPPLANLIST, ORMConstants.KEY_TRIP_TRIPITEM, ORMConstants.KEY_MUL_MANY_TO_MANY);
	
	public void setAnnouncement(vae.PrioritizedAnnouncement value) {
		if (this.announcement != value) {
			vae.PrioritizedAnnouncement lannouncement = this.announcement;
	...
	public vae.PrioritizedAnnouncement getAnnouncement() {
		return announcement;
	}
	...
	@Transient	
	public final vae.AdminSetCollection admin = new vae.AdminSetCollection(this, _ormAdapter, ORMConstants.KEY_TRIPITEM_ADMIN, ORMConstants.KEY_ADMIN_TRIPITEM, ORMConstants.KEY_MUL_MANY_TO_MANY);
	...
	@Transient	
	public final vae.ReviewSetCollection trip_review = new vae.ReviewSetCollection(this, _ormAdapter, ORMConstants.KEY_TRIPITEM_TRIP_REVIEW, ORMConstants.KEY_REVIEW_TRIPITEM, ORMConstants.KEY_MUL_ONE_TO_MANY);
	
	public void setCategory(vae.Category value) {
		if (category != null) {
	...
	public vae.Category getCategory() {
		return category;
	}
	 ...
	 */
	public void setORM_Category(vae.Category value) {
		this.category = value;
	}
	
	private vae.Category getORM_Category() {
		return category;
	}
