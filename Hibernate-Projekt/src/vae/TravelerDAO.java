...
public class TravelerDAO {
	...
	public static Traveler loadTravelerByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Traveler) session.load(vae.Traveler.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Traveler getTravelerByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Traveler) session.get(vae.Traveler.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Traveler loadTravelerByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Traveler) session.load(vae.Traveler.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Traveler getTravelerByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Traveler) session.get(vae.Traveler.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Traveler createTraveler() {
		return new vae.Traveler();
	}
	
	public static boolean save(vae.Traveler traveler) throws PersistentException {
		try {
	...
	public static boolean delete(vae.Traveler traveler) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(vae.Traveler traveler)throws PersistentException {
		try {
			if (traveler.getTravel_service() != null) {
				traveler.getTravel_service().traveler.remove(traveler);
			}
			
			vae.Trip[] lTrips = traveler.trip.toArray();
			for(int i = 0; i < lTrips.length; i++) {
				lTrips[i].setTraveler(null);
			}
			vae.Review[] lReviews = traveler.review.toArray();
			for(int i = 0; i < lReviews.length; i++) {
				lReviews[i].evaluator.remove(traveler);
			}
			vae.MedicalHelp[] lMedical_providers = traveler.medical_provider.toArray();
	...
	public static boolean deleteAndDissociate(vae.Traveler traveler, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (traveler.getTravel_service() != null) {
				traveler.getTravel_service().traveler.remove(traveler);
			}
	...
	public static boolean refresh(vae.Traveler traveler) throws PersistentException {
		try {
	...
	public static boolean evict(vae.Traveler traveler) throws PersistentException {
		try {
