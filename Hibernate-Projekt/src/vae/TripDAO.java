...
public class TripDAO {
	...
	public static Trip loadTripByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Trip) session.load(vae.Trip.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Trip getTripByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Trip) session.get(vae.Trip.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Trip loadTripByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Trip) session.load(vae.Trip.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Trip getTripByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Trip) session.get(vae.Trip.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(vae.Trip trip) throws PersistentException {
		try {
	...
	public static boolean delete(vae.Trip trip) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(vae.Trip trip)throws PersistentException {
		try {
			if (trip.getTraveler() != null) {
				trip.getTraveler().trip.remove(trip);
			}
			
			vae.TripItem[] lTripItems = trip.tripItem.toArray();
	...
	public static boolean deleteAndDissociate(vae.Trip trip, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (trip.getTraveler() != null) {
				trip.getTraveler().trip.remove(trip);
			}
	...
	public static boolean refresh(vae.Trip trip) throws PersistentException {
		try {
	...
	public static boolean evict(vae.Trip trip) throws PersistentException {
		try {
