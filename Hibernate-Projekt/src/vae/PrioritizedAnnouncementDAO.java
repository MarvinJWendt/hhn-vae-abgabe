...
public class PrioritizedAnnouncementDAO {
	...
	public static PrioritizedAnnouncement loadPrioritizedAnnouncementByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (PrioritizedAnnouncement) session.load(vae.PrioritizedAnnouncement.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PrioritizedAnnouncement getPrioritizedAnnouncementByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (PrioritizedAnnouncement) session.get(vae.PrioritizedAnnouncement.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PrioritizedAnnouncement loadPrioritizedAnnouncementByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (PrioritizedAnnouncement) session.load(vae.PrioritizedAnnouncement.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PrioritizedAnnouncement getPrioritizedAnnouncementByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (PrioritizedAnnouncement) session.get(vae.PrioritizedAnnouncement.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PrioritizedAnnouncement createPrioritizedAnnouncement() {
		return new vae.PrioritizedAnnouncement();
	}
	
	public static boolean save(vae.PrioritizedAnnouncement prioritizedAnnouncement) throws PersistentException {
		try {
	...
	public static boolean delete(vae.PrioritizedAnnouncement prioritizedAnnouncement) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(vae.PrioritizedAnnouncement prioritizedAnnouncement)throws PersistentException {
		try {
			vae.Admin[] lSellers = prioritizedAnnouncement.seller.toArray();
	...
	public static boolean deleteAndDissociate(vae.PrioritizedAnnouncement prioritizedAnnouncement, org.orm.PersistentSession session)throws PersistentException {
		try {
			vae.Admin[] lSellers = prioritizedAnnouncement.seller.toArray();
			for(int i = 0; i < lSellers.length; i++) {
				lSellers[i].product.remove(prioritizedAnnouncement);
	...
	public static boolean refresh(vae.PrioritizedAnnouncement prioritizedAnnouncement) throws PersistentException {
		try {
	...
	public static boolean evict(vae.PrioritizedAnnouncement prioritizedAnnouncement) throws PersistentException {
		try {
