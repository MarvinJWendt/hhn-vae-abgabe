...
public class InsuranceDAO {
	...
	public static Insurance loadInsuranceByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Insurance) session.load(vae.Insurance.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Insurance getInsuranceByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Insurance) session.get(vae.Insurance.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Insurance loadInsuranceByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Insurance) session.load(vae.Insurance.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Insurance getInsuranceByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Insurance) session.get(vae.Insurance.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Insurance createInsurance() {
		return new vae.Insurance();
	}
	
	public static boolean save(vae.Insurance insurance) throws PersistentException {
		try {
	...
	public static boolean delete(vae.Insurance insurance) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(vae.Insurance insurance)throws PersistentException {
		try {
			vae.Traveler[] lTravelers = insurance.traveler.toArray();
	...
	public static boolean deleteAndDissociate(vae.Insurance insurance, org.orm.PersistentSession session)throws PersistentException {
		try {
			vae.Traveler[] lTravelers = insurance.traveler.toArray();
			for(int i = 0; i < lTravelers.length; i++) {
				lTravelers[i].setTravel_service(null);
	...
	public static boolean refresh(vae.Insurance insurance) throws PersistentException {
		try {
	...
	public static boolean evict(vae.Insurance insurance) throws PersistentException {
		try {
