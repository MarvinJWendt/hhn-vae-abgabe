...
public class CategoryDAO {
	...
	public static boolean deleteAndDissociate(Category category)throws PersistentException {
		try {
			TripItem[] lTripItemss = category.tripItems.toArray();
	...
	public static boolean deleteAndDissociate(Category category, org.orm.PersistentSession session)throws PersistentException {
		try {
			TripItem[] lTripItemss = category.tripItems.toArray();
			for(int i = 0; i < lTripItemss.length; i++) {
				lTripItemss[i].setCategory(null);
