...
public class TripItemDAO {
	...
	public static TripItem loadTripItemByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (TripItem) session.load(TripItem.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static TripItem getTripItemByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (TripItem) session.get(TripItem.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static TripItem loadTripItemByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (TripItem) session.load(TripItem.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static TripItem getTripItemByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (TripItem) session.get(TripItem.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(TripItem tripItem) throws PersistentException {
		try {
	...
	public static boolean delete(TripItem tripItem) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(TripItem tripItem)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(TripItem tripItem, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (tripItem.getAnnouncement() != null) {
				tripItem.getAnnouncement().setTripItem(null);
			}
	...
	public static boolean refresh(TripItem tripItem) throws PersistentException {
		try {
	...
	public static boolean evict(TripItem tripItem) throws PersistentException {
		try {
