...
public class MedicalHelp implements Serializable {
	...
	@Transient	
	public final TravelerSetCollection patient = new TravelerSetCollection(this, _ormAdapter, ORMConstants.KEY_MEDICALHELP_PATIENT, ORMConstants.KEY_TRAVELER_MEDICAL_PROVIDER, ORMConstants.KEY_MUL_MANY_TO_MANY);
