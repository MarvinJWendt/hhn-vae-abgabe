...
public class Insurance implements Serializable {
	...
	@OneToMany(mappedBy="travel_service", targetEntity= Traveler.class)
	...
	@Transient	
	public final TravelerSetCollection traveler = new TravelerSetCollection(this, _ormAdapter, ORMConstants.KEY_INSURANCE_TRAVELER, ORMConstants.KEY_TRAVELER_TRAVEL_SERVICE, ORMConstants.KEY_MUL_ONE_TO_MANY);
