...
public class VAEPersistentManager extends PersistentManager {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(Traveler.class);
		aMetadataSources.addAnnotatedClass(Admin.class);
		aMetadataSources.addAnnotatedClass(Trip.class);
		aMetadataSources.addAnnotatedClass(Review.class);
		aMetadataSources.addAnnotatedClass(Category.class);
		aMetadataSources.addAnnotatedClass(PrioritizedAnnouncement.class);
		aMetadataSources.addAnnotatedClass(MedicalHelp.class);
		aMetadataSources.addAnnotatedClass(Insurance.class);
		aMetadataSources.addAnnotatedClass(TripItem.class);
	}
