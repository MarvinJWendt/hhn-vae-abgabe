...
public class Traveler extends User implements Serializable {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_TRAVELER_TRAVEL_SERVICE) {
			this.travel_service = (Insurance) owner;
		}
	}
	...
	private Insurance travel_service;
	
	@OneToMany(mappedBy="traveler", targetEntity= Trip.class)
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	private java.util.Set ORM_trip = new java.util.HashSet();
	
	@ManyToMany(mappedBy="ORM_evaluator", targetEntity= Review.class)
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	private java.util.Set ORM_review = new java.util.HashSet();
	
	@ManyToMany(mappedBy="ORM_patient", targetEntity= MedicalHelp.class)
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	...
	@Transient	
	public final TripSetCollection trip = new TripSetCollection(this, _ormAdapter, ORMConstants.KEY_TRAVELER_TRIP, ORMConstants.KEY_TRIP_TRAVELER, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	@Transient	
	public final ReviewSetCollection review = new ReviewSetCollection(this, _ormAdapter, ORMConstants.KEY_TRAVELER_REVIEW, ORMConstants.KEY_REVIEW_EVALUATOR, ORMConstants.KEY_MUL_MANY_TO_MANY);
	...
	@Transient	
	public final MedicalHelpSetCollection medical_provider = new MedicalHelpSetCollection(this, _ormAdapter, ORMConstants.KEY_TRAVELER_MEDICAL_PROVIDER, ORMConstants.KEY_MEDICALHELP_PATIENT, ORMConstants.KEY_MUL_MANY_TO_MANY);
	
	public void setTravel_service(Insurance value) {
	...
	public Insurance getTravel_service() {
	 ...
	 */
	public void setORM_Travel_service(Insurance value) {
		this.travel_service = value;
	}
	
	private Insurance getORM_Travel_service() {
		return travel_service;
	}
