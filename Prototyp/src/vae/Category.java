...
public class Category implements Serializable {
	...
	@OneToMany(mappedBy="category", targetEntity= TripItem.class)
	...
	@Transient	
	public final TripItemSetCollection tripItems = new TripItemSetCollection(this, _ormAdapter, ORMConstants.KEY_CATEGORY_TRIPITEMS, ORMConstants.KEY_TRIPITEM_CATEGORY, ORMConstants.KEY_MUL_ONE_TO_MANY);
