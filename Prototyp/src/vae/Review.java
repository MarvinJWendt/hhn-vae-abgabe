...
public class Review implements Serializable {
	...
	@ManyToOne(targetEntity= TripItem.class, fetch=FetchType.LAZY)
	...
	@ManyToMany(targetEntity= Traveler.class)
	...
	public void setTripItem(TripItem value) {
		if (tripItem != null) {
	 ...
	 */
	public void setORM_TripItem(TripItem value) {
		this.tripItem = value;
	}
	
	private TripItem getORM_TripItem() {
		return tripItem;
	}
	...
	@Transient	
	public final TravelerSetCollection evaluator = new TravelerSetCollection(this, _ormAdapter, ORMConstants.KEY_REVIEW_EVALUATOR, ORMConstants.KEY_TRAVELER_REVIEW, ORMConstants.KEY_MUL_MANY_TO_MANY);
