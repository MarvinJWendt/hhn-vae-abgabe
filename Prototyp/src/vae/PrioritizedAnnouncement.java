...
public class PrioritizedAnnouncement implements Serializable {
	...
	@OneToOne(mappedBy="announcement", targetEntity= TripItem.class, fetch=FetchType.LAZY)
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	...
	@Transient	
	public final AdminSetCollection seller = new AdminSetCollection(this, _ormAdapter, ORMConstants.KEY_PRIORITIZEDANNOUNCEMENT_SELLER, ORMConstants.KEY_ADMIN_PRODUCT, ORMConstants.KEY_MUL_MANY_TO_MANY);
	
	public void setTripItem(TripItem value) {
		if (this.tripItem != value) {
			TripItem ltripItem = this.tripItem;
			this.tripItem = value;
			if (value != null) {
